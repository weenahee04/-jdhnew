...
import { Eye, EyeOff, Bell, User, Sparkles, Wallet, Settings, ArrowRight, Shield, Globe, Award, ChevronRight, ChevronLeft, LogOut, MessageSquare, Loader2 } from 'lucide-react';
    ...
    <div className="animate-fade-in pb-24 md:pb-0">
       ...
       <div className="space-y-6">
          <div className="flex items-center gap-4 bg-zinc-900 p-4 rounded-2xl border border-white/5">
             ...
             <div>
                <h3 className="text-white font-bold text-lg">User888</h3>
          ...
          <button onClick={() => setShowLogoutConfirm(true)} className="w-full py-3 bg-red-500/10 text-red-400 border border-red-500/20 rounded-xl font-medium text-sm hover:bg-red-500/20 transition-colors flex items-center justify-center gap-2">
